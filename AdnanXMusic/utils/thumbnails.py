...
from AdnanXMusic import BOT_ID, LOGGER, app
...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"AdnanXMusic/assets/utils/1.png")
        ...
        font = ImageFont.truetype("AdnanXMusic/assets/utils/font2.ttf", 45)
        ImageFont.truetype("AdnanXMusic/assets/font2.ttf", 70)
        arial = ImageFont.truetype("AdnanXMusic/assets/utils/font2.ttf", 30)
        ImageFont.truetype("AdnanXMusic/assets/font.ttf", 30)
