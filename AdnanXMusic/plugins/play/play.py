...
@app.on_callback_query(filters.regex("AdnanymousAdmin") & ~BANNED_USERS)
async def Adnanymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(filters.regex("AdnanyPlaylists") & ~BANNED_USERS)
@languageCB
