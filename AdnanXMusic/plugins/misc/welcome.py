...
import AdnanXMusic
import AdnanXMusic.modules.sql.welcome_sql as sql
from AdnanXMusic import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
    EVENT_LOGS,
...
from AdnanXMusic.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from AdnanXMusic.modules.helper_funcs.misc import build_keyboard, revert_buttons
from AdnanXMusic.modules.helper_funcs.msg_types import get_welcome_type
from AdnanXMusic.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from AdnanXMusic.modules.log_channel import loggable
from AdnanXMusic.modules.sql.global_bans_sql import is_user_gbanned
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                if not AdnanXMusic.ALLOW_CHATS:
